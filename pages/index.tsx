...
export default function Home({
  ...
  return (
    <div className={styles.container}>
      ...
      <br></br>
      <div className={styles.author}>Tim-Berners Lee</div>
      ...
      <div className={styles.flexContainer}>
        ...
        <div className={styles.featuredText}>
          <div className={styles.postname}>{res.postname}</div>
      ...
      {/* </hr> */}
      <h1 className={styles.upcomingEvents} id="aboutUs">
        {" "}
        About Us
      </h1>
      <div className={styles.aboutUs}>
        DataSci is a club of data science enthusiasts who plan to organize
        events related to this field for students of Nazarbayev University
        including datathon, guest talks, preparation for job interviews and
        more!
      </div>
      <hr className={styles.line}></hr>
      ...
      <div>
        <a
          href="http://instagram.com/nu_datasci"
        ...
        <a
          href="https://www.youtube.com/channel/UC9CxWZp9H3GDhvDRX_eb8tA"
          className={styles.socMediaIcon}
        >
          <i className="fa fa-youtube-play fa-3x" aria-hidden="true">
            {" "}
          </i>
        </a>
      ...
      <div className={styles.bottomText}>
        <i>
          {" "}
          This website was developed by university students on a voluntary
          basis.
        </i>
      </div>
    </div>
