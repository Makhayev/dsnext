  ...
  return (
    <div>
      {auth == false && (
        <div>
          ...
          <input
            ...
            type="password"
          ></input>
          <a className={Styles.bn37} onClick={login}>
            {" "}
            Log in
          </a>
          <hr className={Styles.line}></hr>
      ...
      {auth == true && (
        <div>
          <hr className={Styles.line}></hr>
          <h1 className={Styles.header}>New Post Submission</h1>
          <form>
            <input
              ref={guestnameref}
              className={Styles.shortInput}
            ...
            <input
              ...
              className={Styles.shortInput}
              name="postname"
              placeholder="The name of the Event/Post"
              type="text"
            />
            <textarea
              ref={descriptionref}
            ...
            <input
              ...
              className={Styles.shortInput}
              name="guestnameru"
              placeholder="The Name of the Guest in Russian"
              type="text"
            />
            <input
              ref={postnameruref}
              className={Styles.shortInput}
              name="postnameru"
              placeholder="The name of the Event/Post in Russian"
            ></input>
            <textarea
              ref={descriptionruref}
              className={Styles.largeInput}
              name="descriptionru"
              placeholder="The Description of the Event in Russian"
            />
            {/* <button className = {Styles.submitButton} type = "submit" onClick = {() => submit}>Submit</button> */}
            <a className={Styles.bn37} onClick={submit}>
              Submit
            </a>
          </form>
        </div>
